...
namespace ApiFichaAcademia.Migrations.Migrations
{
    ...
    [Migration("20240603113141_adding-card-relationship-for-objective-and-teacher")]
    partial class addingcardrelationshipforobjectiveandteacher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiFichaAcademia.Models.Model.Card", b =>
                {
                    ...
                    b.HasOne("ApiFichaAcademia.Models.Model.Objective", "Objective")
                        .WithMany()
                        .HasForeignKey("IdObjective")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiFichaAcademia.Models.Model.Teacher", "Teacher")
                        .WithMany()
